...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{LEMMATIZER_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{LEMMATIZER_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
lemmatizer_server.pl - Catalyst Testserver

=head1 SYNOPSIS

lemmatizer_server.pl [options]
